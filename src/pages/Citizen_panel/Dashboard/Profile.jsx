...
const ViewMode = ({ userData, setIsEditing, handleLogout }) => {
  const infoItems = [
    ...
    ...(userData.createdAt ? [{ icon: Calendar, label: "Joined On",   value: new Date(userData.createdAt).toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" }), color: "purple" }] : []),
  ];
    ...
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
        <button
          ...
          style={{ padding: "1rem", background: "linear-gradient(135deg, var(--primary), var(--primary-strong))", color: "white", border: "none", borderRadius: "14px", fontSize: "1rem", fontWeight: "600", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", transition: "all 0.2s ease", fontFamily: "inherit" }}
          onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 20px 40px rgba(43, 80, 255, 0.3)"; }}
        ...
        <button
          ...
          style={{ padding: "1rem", background: "transparent", color: "var(--accent)", border: "1.5px solid var(--accent)", borderRadius: "14px", fontSize: "1rem", fontWeight: "600", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", transition: "all 0.2s ease", fontFamily: "inherit" }}
    ...
    <>
        ...
        {inputFields.map((field) => (
          <div key={field.id}>
            ...
            <input
              ...
              style={{ width: "100%", padding: "0.85rem 1rem", borderRadius: "14px", border: `1px solid ${errors[field.id] ? "var(--accent)" : "var(--border)"}`, background: "color-mix(in srgb, var(--surface) 95%, transparent)", color: "var(--text-primary)", fontSize: "1rem", fontFamily: "inherit", transition: "border 0.2s ease, box-shadow 0.2s ease", boxSizing: "border-box" }}
              onFocus={(e) => { e.currentTarget.style.borderColor = "var(--primary)"; e.currentTarget.style.boxShadow = "0 0 0 4px rgba(43, 80, 255, 0.1)"; }}
              onBlur={(e) => { e.currentTarget.style.borderColor = errors[field.id] ? "var(--accent)" : "var(--border)"; e.currentTarget.style.boxShadow = "none"; }}
            />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
        <button
          ...
          onClick={handleSave}
          disabled={saving}
          style={{ padding: "1rem", background: saving ? "var(--text-muted)" : "linear-gradient(135deg, var(--primary), var(--primary-strong))", color: "white", border: "none", borderRadius: "14px", fontSize: "1rem", fontWeight: "600", cursor: saving ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", transition: "all 0.2s ease", fontFamily: "inherit", opacity: saving ? 0.7 : 1 }}
        >
          {saving ? (
            <><div style={{ display: "inline-block", width: "16px", height: "16px", borderRadius: "50%", border: "2px solid white", borderTopColor: "transparent", animation: "spin 1s linear infinite" }} />Saving...</>
          ) : (
        ...
        <button
          ...
          disabled={saving}
          style={{ padding: "1rem", background: "transparent", color: "var(--text-primary)", border: "1.5px solid var(--border)", borderRadius: "14px", fontSize: "1rem", fontWeight: "600", cursor: saving ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", transition: "all 0.2s ease", fontFamily: "inherit", opacity: saving ? 0.5 : 1 }}
        >
          <X size={20} /> Cancel
        </button>
      </div>
...
const Profile = ({ navigate }) => {
  ...
  if (loading) {
    return (
      <div style={{ background: "var(--surface)", borderRadius: "24px", padding: "3rem", textAlign: "center", border: "1px solid var(--border-soft)" }}>
        <div style={{ display: "inline-block", width: "40px", height: "40px", borderRadius: "50%", border: "3px solid var(--primary)", borderTopColor: "transparent", animation: "spin 1s linear infinite" }} />
  ...
  return (
    <div style={{ background: "var(--surface)", borderRadius: "24px", border: "1px solid var(--border-soft)", boxShadow: "var(--card-shadow)", maxWidth: "900px", margin: "0 auto", overflow: "hidden", position: "relative" }}>
      ...
      <div style={{ background: "linear-gradient(135deg, var(--primary), var(--primary-strong))", padding: "3rem 2rem", textAlign: "center", position: "relative" }}>
        <div style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: "100px", height: "100px", borderRadius: "50%", background: "rgba(255, 255, 255, 0.2)", marginBottom: "1.5rem", position: "relative", border: "3px solid rgba(255, 255, 255, 0.3)" }}>
          ...
          <button
            ...
            style={{ position: "absolute", bottom: "0", right: "0", background: "var(--accent)", borderRadius: "50%", padding: "0.5rem", border: "3px solid white", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", transition: "transform 0.2s ease", fontFamily: "inherit" }}
