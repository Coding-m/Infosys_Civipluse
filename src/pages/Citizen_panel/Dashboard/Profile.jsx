          ...
          return (
            ...
            >
              <div style={{
                ...
                height: "40px",
                borderRadius: "12px",
                background: item.color === "primary" ? colors.bg : colors.bg,
              }}>
                <Icon size={20} color={item.color === "primary" ? "white" : colors.icon} />
              </div>
              <div>
                <p style={{
                  margin: "0 0 0.25rem",
...
const EditMode = ({ editData, setEditData, handleSave, saving, setIsEditing, userData, errors }) => {
  const inputFields = [
    ...
    { id: "email", label: "Email Address", type: "email", value: editData.email },
